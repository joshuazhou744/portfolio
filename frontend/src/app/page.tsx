...
function MobileAlert({ onClose }: { onClose: () => void }) {
  return (
    <div
      className="window mobile-alert-window"
      style={{
        position: 'fixed',
        top: '50%',
        left: '50%',
    ...
    >
      ...
      <div
        ...
        style={{ textAlign: 'center', padding: '1rem', fontSize: '14px' }}
      >
        <p style={{ margin: '0 0 0.5rem 0' }}>This site is designed for larger screens.</p>
        <p style={{ marginTop: '0.5rem', fontSize: '0.9em', marginBottom: '1rem' }}>
...
function AppContent() {
  ...
  const { width: windowWidth, isMounted } = useWindowDimensions();
